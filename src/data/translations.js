  ...
  en: {
    ...
    content: {
      ...
      services: [
        ...
        { id: 2, title: "UI/UX Design", description: "Designing intuitive and visually appealing user interfaces that provide seamless user experiences and drive engagement." },
        { id: 3, title: "Performance Optimization", description: "Optimizing website performance to ensure fast load times, smooth animations, and better search engine rankings." },
        { id: 4, title: "SEO Services", description: "Improving your website's visibility on search engines to attract more organic traffic and potential customers." },
        { id: 5, title: "Progressive Web Apps (PWAs)", description: "Building installable, offline-capable web apps that deliver a native-app-like experience across all devices." },
        { id: 6, title: "Multilingual Support", description: "Implementing internationalization (i18n) to make your website accessible to a global audience in their native languages." },
      ],
      projects: [
  ...
  ar: {
    ...
    content: {
      ...
      services: [
        ...
        { id: 2, title: "تصميم واجهة المستخدم", description: "تصميم واجهات مستخدم بديهية وجذابة بصريًا توفر تجربة مستخدم سلسة وتعزز التفاعل." },
        { id: 3, title: "تحسين الأداء", description: "تحسين أداء الموقع لضمان سرعة التحميل والحركات السلسة وترتيب أفضل في محركات البحث." },
        { id: 4, title: "خدمات SEO", description: "تحسين ظهور موقعك في محركات البحث لجذب المزيد من الزيارات العضوية والعملاء المحتملين." },
        { id: 5, title: "تطبيقات الويب التقدمية", description: "بناء تطبيقات ويب قابلة للتثبيت وتعمل بدون اتصال توفر تجربة شبيهة بالتطبيقات الأصلية." },
        { id: 6, title: "دعم متعدد اللغات", description: "تنفيذ التدويل لجعل موقعك متاحًا لجمهور عالمي بلغاتهم الأم." },
      ],
      projects: [
